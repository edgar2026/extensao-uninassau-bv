...
export const PrimeiroAcessoPage: React.FC = () => {
  ...
  const onSubmit = async (data: CodeAndPasswordInputs) => {
    ...
    try {
      ...
      navigate('/', { state: { message: 'Senha criada com sucesso. Faça login para acessar.' } });
    } catch {
          ...
          >
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="login-montserrat text-center" style={{ fontSize: '13px', fontWeight: '500', color: '#64748b', marginTop: '-4px' }}>
                Informe seu e-mail, o código temporário recebido e crie sua senha.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 mt-6">
              ...
              <div className="auth-field">
                <label className="login-montserrat" style={labelStyle}>Código de primeiro acesso</label>
                <Input
